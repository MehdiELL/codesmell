...
### AI code-quality reviewer on GenLayer
...
**Deployed contract (Testnet Bradbury):** [`0x2b19194E2d56da26B6d902249fBD5e04dE6318ae`](https://explorer-bradbury.genlayer.com/address/0x2b19194E2d56da26B6d902249fBD5e04dE6318ae)
...
2. **`evaluate(id)`** - each validator classifies the content
   (one of: clean, minor-issues, problematic) and scores it 0-100, then must **agree** on the label and a similar
   score via the Equivalence Principle.
3. The **label, score, and reasoning** are written on chain.

## The Intelligent Contract

`contracts/codesmell.py` targets the GenVM Python runner (pinned by hash):

- **Integers only** - the smell score is `u8` (0-100); no floats.
...
genvm-lint check contracts/codesmell.py
